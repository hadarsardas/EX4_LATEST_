...
static void copyConst() {
    ...
    Enigma smurf_enigma = mtm::escaperoom::Enigma("blue mystery",
                                                  (Difficulty) 2);
    Enigma smurf_enigma2 = mtm::escaperoom::Enigma("deep in the forest",
                                                  (Difficulty) 1);
    Enigma smurf_enigma3 = mtm::escaperoom::Enigma("gargamel",
                                                  (Difficulty)0);
